export class HelpMessage {
  static getGeneralCommandsText(): string {
    return (
  ...
  static getGeneralBotHelpText(): string {
    return `> To invoke the PR-Agent, add a comment using one of the following commands:  \n${HelpMessage.getGeneralCommandsText()} \n`;
  }

  static getReviewUsageGuide(): string {
    let output = '**Overview:**\n';
    output +=
...
\`\`\`
  ...
  static getDescribeUsageGuide(): string {
    let output = '**Overview:**\n';
    output +=
    ...
    output +=
      'The tool can be triggered [automatically](https://pr-agent-docs.codium.ai/usage-guide/automations_and_usage/#github-app-automatic-tools-when-a-new-pr-is-opened) every time a new PR is opened, or can be invoked manually by commenting on a PR.\n';
    output += `\
...
`;
    ...
    output += HelpMessage.getGeneralBotHelpText();
    output += '\n\n</details></td></tr>\n\n';
    output += '</table>';
  ...
  static getAskUsageGuide(): string {
    let output = '**Overview:**\n';
    output += `\
...
You can ask questions about the entire PR, about specific code lines, or about an image related to the PR code changes.
  ...
  static getImproveUsageGuide(): string {
    let output = '**Overview:**\n';
...
`;
  ...
  static getHelpDocsUsageGuide(): string {
    let output = '**Overview:**\n';
    output += `\
