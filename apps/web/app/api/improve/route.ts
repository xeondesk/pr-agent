...
import { improveRequestSchema, type ImproveRequest } from '@/lib/api/schemas';
import type { ApiRequest } from '@/lib/api/types';
import { createSSEHeaders, fetchGitHubPR, createAIHandler, encodeSSE } from '../utils';
import { executeTool } from '@/lib/tools';
import { ApiError } from '@/lib/api/errors';

async function handler(req: ApiRequest<ImproveRequest>) {
...
export const POST = withAuth(improveRequestSchema, handler, {
